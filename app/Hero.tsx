		...
		>
			<div className='hero-text flex flex-col items-center'>
				<motion.h1
					...
					className='mx-auto pb-3 px-4 text-center text-3xl font-bold text-white max-w-4xl md:text-5xl md:pb-6 xl:text-7xl xl:text-left'
				>
				...
				<motion.h1
					...
					className='mx-auto pb-4 px-4 text-center text-3xl font-bold text-white max-w-4xl md:text-5xl md:pb-6 xl:text-7xl xl:text-right xl:pb-20'
				>
					Transforming ambition to action.
				</motion.h1>
				...
				<motion.button
					...
					onClick={() => {
						window
							.open(
								"https://forms.gle/q3PLA7gUqBxjKJn88",
								"_blank"
							)
							?.focus();
					}}
